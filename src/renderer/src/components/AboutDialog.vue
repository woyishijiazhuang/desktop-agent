...
/**
 * 关于弹窗（由侧栏底部「关于」按钮触发）。
 * 取代原 /about 路由页：内容轻量，弹窗形式更轻；设置仍走独立路由页。
 */
...
<template>
  <NModal
    ...
    preset="card"
    title="关于"
    :style="{ width: '460px', maxWidth: 'calc(100vw - 48px)' }"
  ...
  >
    <div class="about">
      <div class="about__head">
        ...
        <div>
          ...
          <p class="about__subtitle">
            本地优先的 AI 对话助手
            <span v-if="version" class="about__version">v{{ version }}</span>
          </p>
        </div>
      </div>
      ...
      <section class="about__section">
        ...
        <p class="about__text">
          基于 <code>Electron</code> + <code>Vue 3</code> + <code>TypeScript</code> 构建的桌面端 AI
          对话助手。支持多家模型服务商与自定义 OpenAI/Anthropic 兼容端点，API Key
          经系统安全存储加密，不会离开你的设备。
        </p>
        <p class="about__text">
      ...
      <section class="about__section">
        ...
        <ul class="about__list">
          ...
          <li><code>@earendil-works/pi-ai</code> + <code>pi-agent-core</code> 模型与 Agent 能力</li>
